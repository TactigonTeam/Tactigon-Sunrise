...
#ifndef COMAU_HW_CONTROLLER_LOOP_HPP_
#define COMAU_HW_CONTROLLER_LOOP_HPP_
...
class ComauControl : public controller_interface::ControllerInterface
{
public:
