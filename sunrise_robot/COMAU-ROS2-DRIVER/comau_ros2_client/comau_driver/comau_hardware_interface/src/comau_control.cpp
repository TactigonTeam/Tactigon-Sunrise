...
{
ComauControl::ComauControl() : controller_interface::ControllerInterface() {}

controller_interface::CallbackReturn ComauControl::on_init()
{
...
controller_interface::InterfaceConfiguration  ComauControl::command_interface_configuration()
  const
{
...
controller_interface::InterfaceConfiguration   ComauControl::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL, {}};
...
controller_interface::CallbackReturn   ComauControl::on_configure(const rclcpp_lifecycle::State &)
{
  auto callback =
...
controller_interface::CallbackReturn   ComauControl::on_activate(const rclcpp_lifecycle::State &)
{
...
controller_interface::return_type ComauControl::update(
...
controller_interface::CallbackReturn   ComauControl::on_deactivate(const rclcpp_lifecycle::State &)
{
  release_interfaces();
...
controller_interface::CallbackReturn   ComauControl::on_cleanup(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn   ComauControl::on_error(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn   ComauControl::on_shutdown(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}
...
PLUGINLIB_EXPORT_CLASS(
  comau_hardware_interface::ComauControl, controller_interface::ControllerInterface)
