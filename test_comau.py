...
class TestNode(Node):
    ...
    @staticmethod
    def get_braccio_command(positions: list[float]) -> BraccioJointCommand:
        bc = BraccioJointCommand(
            trajectory=[
                JointPose(
                    positions=positions
                )
    ...
    def send_braccio_command(self, command: BraccioJointCommand):
...
class TestWindow(QMainWindow):
    ...
    def main_layout(self):
        ...
        braccio_1_btn = QPushButton("Braccio position 1", self._container)
        braccio_1_btn.clicked.connect(lambda: self._node.send_braccio_command(TestNode.get_braccio_command([
            0.0,
            0.0,
            -1.57,
            0.0,
        ...
        braccio_2_btn = QPushButton("Braccio position 2", self._container)
        braccio_2_btn.clicked.connect(lambda: self._node.send_braccio_command(TestNode.get_braccio_command([
            0.0,
            -0.5,
            -1.5,
            0.0,
